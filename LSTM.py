...
# === Main prediction function with logging ===
...
# --- Thread wrapper to avoid freezing GUI ---
...
def run_and_plot():
    ...
    # --- Aggregate states in 30-day chunks using mode ---
    ...
    # Dates corresponding to aggregated states (first day of each chunk)
